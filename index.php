...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-KCB7V3MPRZ"></script>
    <script>
                ...
                for ($j = 2; $j < count($rows[$i]); $j++) {
                    if ($rows[$i][$j] != 'none') {
                        ...
                        foreach ($rows[$i][$j] as $lesson) {
                            ...
                            $subject = str_replace('hist.i', 'historia i społeczeństwo', $subject);
